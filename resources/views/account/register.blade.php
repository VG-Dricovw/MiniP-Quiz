...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class=" text-white mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Register a new account</h2>
  </div>
  ...
  <div class="mt-10  sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <!-- <input type="hidden" name="_token" value="{{ csrf_token() }}" /> -->
      ...
      <div>
       ...
       <a href="/login" class="flex w-full mt-10 justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-500"><button>Go to login</button></a>
